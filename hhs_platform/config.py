# FILE: hhs_platform/config.py - FIXED FOR DAGSTER-TEST
"""Configuration updated for dagster-test directory"""
import os
...
class HHSConfig(BaseSettings):
    ...
    # FIXED: Update paths for dagster-test directory
    dbt_project_dir: Path = Field(default=Path(__file__).parent.parent / "dagster_test")  # Changed from ecids_test
